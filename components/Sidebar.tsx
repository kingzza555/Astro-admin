...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 bg-white h-screen flex flex-col fixed left-0 top-0 border-r border-slate-100">
            ...
            <div className="p-4 m-4 border-t border-slate-100">
                <div className="flex items-center gap-3 px-2 py-2">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-400 truncate">admin@astro.app</p>
                    </div>
